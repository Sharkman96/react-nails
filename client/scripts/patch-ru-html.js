...
const RU_FAQ_JSON_LD = `        {
          ...
          "mainEntity": [
            ...
            {
              "@type": "Question",
              "name": "Чем отличаются гель-ногти от гель-лака?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Гель-лак укрепляет натуральный ноготь цветным покрытием. Наращивание или укрепление гелем даёт больше длины и прочности — если вам нужны более длинные ногти в Штутгарте."
              }
            }
          ]
        }`;
